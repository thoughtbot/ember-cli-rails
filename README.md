...
1. Execute `rails generate ember:heroku` (run "$git add ." and commit to include the generated files)
...
```
Important: verify if your Gemfile is written with a capital G, your build will fail otherwise 
